...
def escribir_a_jsonl(data, output_path):
    """Escribe los datos en formato JSON Lines."""
    modo = 'a' if os.path.exists(output_path) else 'w'
...
def procesar_archivo(input_path, output_jsonl, batch_size=10):
        ...
        for row in reader:
            ...
            try:
                ...
                if len(processed_words) % batch_size == 0:
                    if all_words:
                        escribir_a_jsonl(all_words, output_jsonl)
...
if __name__ == "__main__":
    ...
    output_jsonl = "./palabras_definiciones_6_letras_test.jsonl"  # Cambiar la extensión a .jsonl
    related_path = "./palabras_relacionadas_test.csv"
